<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/img/auto2000-icon-sm.png')}}">
    ...
    <link href="{{asset('assets/js/plugins/dataTables/FixedHeader/css/fixedHeader.bootstrap.min.css')}}" rel="stylesheet">
