        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Monitoring Tindakan Sales Account</h5>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div class="btn-group btn-group-sm">
                                            <button class="btn btn-info" type="button" data-toggle="tooltip" data-placement="left" title="Detail"><i class="fa fa-list"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
